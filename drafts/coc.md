...
Recently I switched from *Vim* to *NeoVim* because some people keep telling me that Vim is bloated and yadayada.
...
At first I found this when I got an error on *printf*:
